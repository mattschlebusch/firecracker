...
use crate::guest_config::templates::CpuConfigurationTypes;
...
impl KvmVcpu {
    ...
    pub fn configure(
        ...
        let cpuid = if let CpuConfigurationTypes::Custom(custom_template) = &vcpu_config.cpu_config
        {
        ...
        let static_cpu_template =
            if let CpuConfigurationTypes::Static(static_template) = &vcpu_config.cpu_config {
                static_template
            } else {
...
mod tests {
    ...
    fn test_configure_vcpu() {
        ...
        let mut vcpu_config = VcpuConfig {
            vcpu_count: 1,
            smt: false,
            cpu_config: CpuConfigurationTypes::default(),
        };
        ...
        vcpu_config.cpu_config = CpuConfigurationTypes::Static(CpuFeaturesTemplate::T2);
        ...
        vcpu_config.cpu_config = CpuConfigurationTypes::Static(CpuFeaturesTemplate::C3);
        ...
        vcpu_config.cpu_config = CpuConfigurationTypes::Static(CpuFeaturesTemplate::T2S);
        ...
        if is_at_least_cascade_lake() {
            ...
            vcpu_config.cpu_config = CpuConfigurationTypes::Static(CpuFeaturesTemplate::T2CL);
        ...
        // Test configure while using the T2S template.
        vcpu_config.cpu_config = CpuConfigurationTypes::Static(CpuFeaturesTemplate::T2A);
