...
use crate::vstate::vcpu::{self, Vcpu, VcpuConfig};
...
pub enum BuildMicrovmFromSnapshotError {
    ...
    CpuidNewError(#[from] cpuid::CpuidNewError),
    ...
    EmulateSerialInit(#[from] EmulateSerialInitError),
    ...
    StartVcpus(#[from] StartVcpusError),
