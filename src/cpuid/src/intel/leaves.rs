...
impl<
        A: bit_fields::BitField,
        B: bit_fields::BitField,
        C: bit_fields::BitField,
        D: bit_fields::BitField,
    > Leaf<A, B, C, D>
{
    /// Comapres `self` to `other` ignoring undefined bits.
    #[must_use]
